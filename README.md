# BD9E300EFJ-EVK-001 Design Resource Repository
* Hardware Design Files and Documentation for the ROHM BD9E300EFJ-EVK-001 EVK

----
### Description: 
* BD9E300EFJ-LB is a synchronous buck switching regulator with built-in power MOSFETs. 
* It is capable of an output current of up to 2.5A. 
* It has a high oscillation frequency of 1MHz while using small inductance value. 
...
----
### Where to Purchase?
* http://www.rohm.com/web/global/distribution/-/dinventory/BD9E300EFJ-EVK-001/sample/0
